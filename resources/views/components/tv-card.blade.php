<div class="mt-8">
    ...
    <div class="mt-2">
        <a href="{{ route('tv.show',$tvshow['id']) }}" class="text-lg hover:text-gray-400">{{ $tvshow['name'] }}</a>
        <div class="flex items-center text-gray-400 ">
            ...
            <span class="ml-2 text-sm tracking-wider">{{ $tvshow['vote_average']}}/10</span>
            <span class="mx-2 text-sm ">|</span>
            <span class="text-sm">{{ $tvshow['first_air_date']}}</span>
        </div>
        <div class="text-gray-400 text-xs">{{ $tvshow['genres'] }}</div>
    </div>
</div>
