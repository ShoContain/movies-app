    ...
    <nav class="border-b border-gray-700">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
           <ul class="flex flex-col md:flex-row items-center">
               <li>
                   <a href="{{ route('movies.index') }}" class="hover:text-gray-200">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:ml-4 md:mt-0">
                    <input type="text" class="bg-gray-600 rounded-full w-56 px-4 py-1 pl-10 focus:outline-none focus:shadow-outline text-sm" placeholder="検索">
                ...
                <div class="mt-3 md:ml-4 md:mt-0">
                    <img src="/img/dog.jpg" alt="dog" class="rounded-full w-8 h-8">
                </div>
            </div>
