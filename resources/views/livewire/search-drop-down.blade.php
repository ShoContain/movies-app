<div class="relative mt-3 md:ml-4 md:mt-0" x-data="{isOpen:true}" @click.away="isOpen=false">
    <input
        wire:model.debounce.200ms="search" type=text" class="bg-gray-600 rounded-full w-56 px-4 py-1 pl-10 focus:outline-none focus:shadow-outline text-sm" placeholder="検索 ( / )"
        x-ref="search"
        @keydown.window="
    ...
    @if(strlen($search)>=1)
        <div
            class="absolute bg-gray-800 rounded w-64 mt-4 text-sm z-20"
                ...
                <ul class="">
                        <li class="border-b border-gray-700">
                            <a
                                ...
                                class="block hover:bg-gray-700 hover:shadow-outline px-3 py-2 flex items-center"
